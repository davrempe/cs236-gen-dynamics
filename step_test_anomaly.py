...
#         test_writer.add_summary(summary, step)
    ...
    print('NLL mean: %f' % (np.mean(losses)))
    print('NLL std: %f' % (np.std(losses)))

    num_fake = (num_fake / float(batch_idx)) * 100.0
    num_real = (num_real / float(batch_idx)) * 100.0
    print('Classified real: %f' % (num_real))
    print('Classified fake: %f' % (num_fake))
